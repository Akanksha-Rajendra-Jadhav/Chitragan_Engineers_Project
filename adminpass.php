...
<body>
    ...
    <form action="adminpass_change.php" method="post" style="margin-left: 30%; margin-top:10%">
        <h3>Enter New Password : <input type="password" name="oldid"><br></h3>
        <h3>Enter Confirm Password : <input type="password" name="newid"><br></h3>
        <input type="hidden" value="<?php echo $adminid ;?>" name="adminid_c">
